  ...
  <div class="card">
    ...
    <div class="card-content has-text-left">
      <section class="content">
        <h4>
          <svg class="octicon octicon-repo" viewBox="0 0 12 16" version="1.1" aria-hidden="true">
        ...
        <p>
          ...
          <span class="has-text-yellow">
            <svg class="octicon octicon-star" viewBox="0 0 14 16" version="1.1" aria-hidden="true">
              <path fill-rule="evenodd" d="M14 6l-4.9-.64L7 1 4.9 5.36 0 6l3.6 3.26L2.67 14 7 11.67 11.33 14l-.93-4.74L14 6z" />
            </svg>
            {{ stargazers_count.toLocaleString() }}
          </span>&nbsp;
          <span>
            <svg class="octicon octicon-repo-forked" viewBox="0 0 10 16" version="1.1" aria-hidden="true">
    ...
    <footer class="card-footer">
      <p class="card-footer-item">
        <span>
          View on <a :href="html_url" target="_blank">GitHub <i class="fab fa-github" /></a>
        </span>
      </p>
      <p class="card-footer-item">
        <span>
          Share on <a :href="`https://twitter.com/share?url=${html_url}`" target="_blank"> Twitter <i class="fab fa-twitter" /></a>
        </span>
      </p>
    </footer>
  </div>
...
export default Vue.extend({
  ...
  async mounted () {
    const repository = await this.$axios.$get(`https://api.github.com/repos/tsunematsu21/${this.repo}`)
